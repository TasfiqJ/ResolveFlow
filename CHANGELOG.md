...
## Technical preview - 2026-07-22

- Built the shared Resolve and Replay production path for a synthetic payments incident.
- Added authorization-before-retrieval, hybrid retrieval, bounded agent execution, deterministic verification, exact approval binding, idempotent connector recovery, and public-safe audit projection.
